...
- **`service_layers/`**: Regras de negócio puras e validações de domínio. Não pode importar Flask.
...
`.venv`, `.ruff_cache` e `.vscode` sao artefatos de ambiente local. Eles nao sao arquitetura do produto nem topologia oficial da raiz.
