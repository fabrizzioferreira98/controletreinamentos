"""COMPAT: wrapper historico para backup.
...
from backend.tools.maintenance.run_backups import main


COMPAT_NOTICE = (
    "Compatibilidade: scripts/backup/run_backups.py e alias historico; "
