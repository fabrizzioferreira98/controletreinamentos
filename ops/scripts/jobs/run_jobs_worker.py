"""IMPLEMENTATION: worker de jobs usado pela entrada canonica.
...
DIRECT_ENTRY_NOTICE = (
    "Entrada direta despriorizada: ops/scripts/jobs/run_jobs_worker.py e implementacao; "
...
def main() -> int:
    ...
    app.logger.info(
        "Job worker command started.",
        extra={
            "event": "worker_startup",
            "component": "jobs_worker_cli",
            "max_jobs": max_jobs,
    ...
    try:
        while True:
            ...
            if cycles >= max_cycles:
                app.logger.warning(
                    "Job worker drain cycle limit reached.",
                    extra={
                        "event": "worker_drain_limit_reached",
                        "component": "jobs_worker_cli",
                        "max_cycles": max_cycles,
                        **aggregated,
                    },
        ...
        app.logger.exception(
            "Job worker command failed unexpectedly.",
            extra={
                "event": "worker_unexpected_failure",
                "component": "jobs_worker_cli",
                "cycles": cycles,
                **aggregated,
            },
