...
def _initialize_pool(url: str) -> None:
    ...
    current_app.logger.info(
        ...
        extra={
            ...
            "min_conn": _pg_pool_config["min_conn"],
            "max_conn": _pg_pool_config["max_conn"],
            "application_name": _pg_pool_config["connect_kwargs"].get("application_name"),
            "statement_timeout_configured": "options" in _pg_pool_config["connect_kwargs"],
        },
    )
