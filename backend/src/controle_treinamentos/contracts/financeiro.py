    ...
    "resources": {
        ...
        "lancamentos_jornada": {
            "canonical_paths": (
                ...
                "/api/v1/financeiro/lancamentos-jornada/<id> [DELETE]",
...
def serialize_finance_mission(row: dict) -> dict:
    ...
    return {
        ...
        "terceiro_tripulante_id": _as_optional_int(row.get("terceiro_tripulante_id")),
        "terceiro_tripulante_funcao": _as_text(row.get("terceiro_tripulante_funcao")),
        "terceiro_tripulante_nome": _as_text(row.get("terceiro_tripulante_nome")),
