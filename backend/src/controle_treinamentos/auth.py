...
ENDPOINT_PERMISSION_MAP = {
    ...
    "cadastros.api_tripulante_operational_periods_list": ("tripulantes:view", "relatorio_individual:view"),
    "cadastros.api_tripulante_operational_periods_create": "tripulantes:edit",
    "cadastros.api_tripulante_operational_periods_delete": "tripulantes:edit",
