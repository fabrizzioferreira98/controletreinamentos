            ...
            return jsonify(
                {
                    ...
                    "execution_state": "enqueued",
                    "processed": False,
                    "message": "Backup enfileirado com sucesso. HTTP 202 confirma enqueue, nao execucao.",
                    "completion_evidence": "Consultar status do job ate running/succeeded/dead_letter.",
                    "terminal_states": ["succeeded", "dead_letter"],
                }
            ), 202
        ...
        return jsonify(
            {
                ...
                "execution_state": "enqueued",
                "processed": False,
                "message": "Notificacoes enfileiradas com sucesso. HTTP 202 confirma enqueue, nao execucao.",
                "completion_evidence": "Consultar status do job ate running/succeeded/dead_letter.",
                "terminal_states": ["succeeded", "dead_letter"],
            }
        ), 202
