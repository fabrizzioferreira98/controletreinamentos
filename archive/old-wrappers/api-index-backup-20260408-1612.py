...
# Garantir import do pacote da aplicacao em entrypoints HTTP de compatibilidade.
        ...
        return jsonify(
            {
                "success": False,
                "error": "BOOT_FAILURE",
                "message": "Falha interna ao inicializar a aplica̤̣o.",
                "error_ref": error_ref,
            }
        ), 500
...
def _init_wsgi_compat_app():
    try:
        from backend.src.controle_treinamentos.compat.http_entrypoints.index import app
