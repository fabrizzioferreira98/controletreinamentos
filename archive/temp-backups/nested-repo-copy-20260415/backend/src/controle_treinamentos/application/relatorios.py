...
from ..repositories.queries import (
    delete_produtividade_conferencia,
    fetch_competencias_disponiveis,
    fetch_produtividade_conferencia,
    fetch_produtividade_conferencias_map,
    tripulante_exists,
    upsert_produtividade_conferencia,
)
...
def set_produtividade_conferencia(
    ...
    *,
    ...
    tripulante = tripulante_exists(db, tripulante_id=tripulante_id)
    if not tripulante:
    ...
    if normalized_action == "mark":
        previous = fetch_produtividade_conferencia(
            db,
        ...
        current = fetch_produtividade_conferencia(
            db,
            tripulante_id=tripulante_id,
            competencia=normalized_competencia,
        )
        ...
        return {
            ...
            "conferencia": serialize_produtividade_conferencia(current),
        }
