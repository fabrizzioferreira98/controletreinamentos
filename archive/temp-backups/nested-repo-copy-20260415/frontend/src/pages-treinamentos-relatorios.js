import {
  ...
  showFlash,
  trainingStatusClass,
} from "./lib.js?v=20260404-1215";
import { renderShell } from "./shell.js?v=20260404-1215";
      ...
      `
        ...
        <section class="panel training-root-panel">
          <div class="training-root-tab-shell">
            <nav class="training-root-tab-nav" aria-label="Seções do cadastro raiz">
              <button type="button" class="training-root-tab${activeTab === "types" ? " is-active" : ""}" data-training-root-tab="types" id="training-root-tab-button-types" role="tab" aria-selected="${activeTab === "types" ? "true" : "false"}" aria-controls="training-root-tab-types">
                <span>Tipos de treinamento</span>
                <span class="training-root-tab-count">${formatInteger(types.length)}</span>
              </button>
              <button type="button" class="training-root-tab${activeTab === "segments" ? " is-active" : ""}" data-training-root-tab="segments" id="training-root-tab-button-segments" role="tab" aria-selected="${activeTab === "segments" ? "true" : "false"}" aria-controls="training-root-tab-segments">
                <span>Segmentos teóricos</span>
                <span class="training-root-tab-count">${formatInteger(segmentCount)}</span>
              </button>
              <button type="button" class="training-root-tab${activeTab === "hours" ? " is-active" : ""}" data-training-root-tab="hours" id="training-root-tab-button-hours" role="tab" aria-selected="${activeTab === "hours" ? "true" : "false"}" aria-controls="training-root-tab-hours">
