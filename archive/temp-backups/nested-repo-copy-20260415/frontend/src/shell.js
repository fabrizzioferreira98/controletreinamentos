import { api, capabilitySet, config, consumeFlash, escapeHtml, routePath, showFlash, state } from "./lib.js?v=20260404-1215";
      ...
      <section class="login-visual login-entrance" aria-hidden="true">
        <div class="login-visual-photo-wrap">
          <img
            ...
            src="/static/login-citation-jet.jpg?v=20260403-login"
            alt=""
            loading="eager"
            fetchpriority="high"
            decoding="async"
