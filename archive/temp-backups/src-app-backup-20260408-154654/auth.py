...
MODULE_PERMISSION_GROUPS = [
    {
        ...
        "items": [
            ...
            ("tv_vencimentos:view", "Painel TV vencimentos"),
            ("tv_produtividade:view", "Painel TV produtividade"),
        ],
    },
    {
        "key": "operacoes",
        ...
        "items": [
            ...
            ("missoes:view", "Missões"),
            ("missoes:create", "Criar missões"),
            ("missoes:edit", "Editar missões"),
            ("missoes:delete", "Excluir missões"),
    ...
    },
    {
        ...
        "items": [
            ...
            ("relatorio_produtividade:view", "Relatórios de produtividade"),
            ("produtividade_adicionais:view", "Adicionais excepcionais"),
            ("produtividade_adicionais:create", "Criar adicionais excepcionais"),
            ("produtividade_adicionais:edit", "Editar adicionais excepcionais"),
            ("produtividade_adicionais:delete", "Excluir adicionais excepcionais"),
        ],
    },
    {
        "key": "cadastros",
...
DEFAULT_OPERATOR_PERMISSIONS = {
    ...
    "produtividade_adicionais:view",
    "produtividade_adicionais:create",
    "produtividade_adicionais:edit",
    "produtividade_adicionais:delete",
    "cadastros:view",
    "tripulantes:view",
    "tripulantes:create",
    "tripulantes:edit",
...
ENDPOINT_PERMISSION_MAP = {
    ...
    "dashboard.painel_tv": "tv_vencimentos:view",
    "dashboard.painel_tv_dados": "tv_vencimentos:view",
    ...
    "dashboard.api_tv_vencimentos": "tv_vencimentos:view",
    "dashboard.api_tv_produtividade": "tv_produtividade:view",
    "relatorios.produtividade_painel_tv": "tv_produtividade:view",
    "relatorios.produtividade_painel_tv_dados": "tv_produtividade:view",
    # Operações
    "operacoes.missoes_list": "missoes:view",
    "operacoes.missoes_new": "missoes:create",
    "operacoes.missoes_edit": "missoes:edit",
    "operacoes.missoes_delete": "missoes:delete",
    ...
    "relatorios.produtividade_consolidado": "relatorio_produtividade:view",
    "relatorios.produtividade_consolidado_export_pdf": "relatorio_produtividade:view",
    "relatorios.produtividade_conferencia_set": "relatorio_produtividade:view",
    "relatorios.api_relatorios_habilitacoes": "relatorio_habilitacoes:view",
    "relatorios.api_relatorios_produtividade": "relatorio_produtividade:view",
    "relatorios.api_relatorios_produtividade_conferencias": "relatorio_produtividade:view",
    "cadastros.produtividade_tripulante": "relatorio_produtividade:view",
    "cadastros.produtividade_tripulante_export_pdf": "relatorio_produtividade:view",
    "relatorios.produtividade_adicionais_list": "produtividade_adicionais:view",
    "relatorios.produtividade_adicionais_new": "produtividade_adicionais:create",
    "relatorios.produtividade_adicionais_edit": "produtividade_adicionais:edit",
    "relatorios.produtividade_adicionais_delete": "produtividade_adicionais:delete",
    # Cadastros
...
def normalize_permissions(value, *, perfil: str = "operador") -> set[str]:
    ...
    if isinstance(value, str):
        raw = value.strip()
        if not raw:
            return set(DEFAULT_OPERATOR_PERMISSIONS)
        try:
    ...
    dependencies = {
        ...
        "missoes:create": {"missoes:view"},
        "missoes:edit": {"missoes:view"},
        "missoes:delete": {"missoes:view"},
        ...
        "produtividade_adicionais:create": {"produtividade_adicionais:view"},
        "produtividade_adicionais:edit": {"produtividade_adicionais:view"},
        "produtividade_adicionais:delete": {"produtividade_adicionais:view"},
    }
    for key in list(selected):
        selected.update(dependencies.get(key, set()))
    return selected or set(DEFAULT_OPERATOR_PERMISSIONS)
