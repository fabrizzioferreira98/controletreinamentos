...
TRAINING_ATTACHMENT_MAX_MB = max(1, int((os.getenv("TRAINING_ATTACHMENT_MAX_MB", "8") or "8").strip()))
...
AUDIT_ENTITY_LABELS = {
    ...
    "produtividade_adicional_excepcional": "Adicional excepcional",
    "missao_operacional": "Missao operacional",
