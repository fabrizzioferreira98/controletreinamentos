import { api, capabilitySet, config, consumeFlash, escapeHtml, routePath, showFlash, state } from "./lib.js?v=20260408-143932";
      ...
      <section class="login-visual login-entrance" aria-hidden="true">
        <div class="login-visual-photo-wrap">
          <img
            ...
            src="/static/login-citation-jet.jpg?v=20260408-143932"
            alt=""
            loading="eager"
            fetchpriority="high"
            decoding="async"
