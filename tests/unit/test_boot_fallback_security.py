...
def _entrypoint_path(file_name: str) -> Path:
    return (
...
def test_http_boot_fallback_response_is_sanitized():
    module = _load_module("api_index_boot_fallback_test", _entrypoint_path("index.py"))
...
def test_cron_boot_failure_response_is_sanitized():
    module = _load_module("api_cron_boot_fallback_test", _entrypoint_path("cron.py"))
