...
import { renderTrainingAttachmentSection } from "./attachments.20260430-142420.1b7817c68ca7.js";
import {
  buildDuePreview,
        ...
        <section class="panel training-record-form-panel ui-surface ui-stack">
          ...
          <form id="training-program-record-form" class="form-grid entity-form-grid training-record-form ui-form-grid" novalidate>
            ...
            <section class="form-section entity-form-section ui-surface ui-stack ui-form-section">
              ...
              <div class="form-grid form-grid-compact ui-form-grid ui-form-density-compact">
            <label>Data de realização<input type="date" name="data_realizacao" id="trainingRecordDate" value="${escapeAttr(record.data_realizacao || "")}" required aria-describedby="trainingRecordDateFeedback"><span class="field-feedback ui-field-help" id="trainingRecordDateFeedback" aria-live="polite"></span></label>
            <label>Data de vencimento<input type="text" id="trainingRecordDuePreview" value="${escapeAttr(duePreview.label)}" readonly><span class="field-help ui-field-help">Calculada a partir da realização e periodicidade do segmento.</span></label>
            <label class="full-width ui-form-field-long">Observação<textarea name="observacao" rows="3">${escapeHtml(record.observacao || "")}</textarea></label>
            ${
  ...
  try {
    ...
    renderShell(
      `
        ...
        <form id="treinamento-form" class="form-grid ui-form-grid">
          <label>
            Tripulante
