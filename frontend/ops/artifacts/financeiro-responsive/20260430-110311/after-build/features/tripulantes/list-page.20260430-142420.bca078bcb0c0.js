        ...
        `
          <section class="panel report-shell report-state-panel">
            <div class="feedback info" role="status" aria-live="polite">
              ...
              <span>Aplicando filtros para manter contexto antes de abrir visualização, PDF ou evid&ecirc;ncias.</span>
            </div>
          </section>
        `,
        pageTitle,
              ...
              ? `
                <section class="report-context-strip">
                  ...
                  <div class="report-context-items">
                    ...
                    <div class="report-context-item"><span>Saída</span><strong>Tela, PDF e evid&ecirc;ncias</strong></div>
                  </div>
                </section>
              `
              : ""
