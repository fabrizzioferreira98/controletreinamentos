...
import { renderForbiddenRoute, routeAllowed } from "./guards.js";
import { resolveRoute, withFrontendPhase } from "./router.js";
...
export async function startApp() {
  ...
  state.navigationRender = {
    bootId: perf.bootId,
    routeKey: startupRoute,
  };
