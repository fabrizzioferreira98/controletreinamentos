...
export const NAV_GROUPS = [
  {
    ...
    items: [
      ...
      { label: "Dashboard Operacional", href: "#/dashboard-operacional", permission: "dashboard:view", match: (route) => route === "#/dashboard-operacional", icon: "operations" },
    ],
  },
  {
    label: "Operações",
  ...
  },
  {
    ...
    icon: "bars",
    items: [
      { label: "Lançamentos de Jornada", href: "#/financeiro/lancamentos-jornada", permission: "finance:bonuses:read", match: (route) => route.startsWith("#/financeiro/lancamentos-jornada") || route.startsWith("#/financeiro/bonificacoes"), icon: "bars" },
